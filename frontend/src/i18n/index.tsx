...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    dashboard: "工作台", planList: "行程列表", newPlan: "新建行程",
  ...
  en: {
    ...
    dashboard: "Dashboard", planList: "Plans", newPlan: "New Plan",
  ...
  ja: {
    ...
    dashboard: "ダッシュボード", planList: "プラン一覧", newPlan: "新規プラン",
  ...
  ko: {
    ...
    dashboard: "대시보드", planList: "여행 목록", newPlan: "새 여행",
  ...
  fr: {
    ...
    dashboard: "Tableau de bord", planList: "Plans", newPlan: "Nouveau plan",
  ...
  de: {
    ...
    dashboard: "Dashboard", planList: "Pläne", newPlan: "Neuer Plan",
  ...
  es: {
    ...
    dashboard: "Panel", planList: "Planes", newPlan: "Nuevo plan",
  ...
  ru: {
    ...
    dashboard: "Панель", planList: "Планы", newPlan: "Новый план",
  ...
  pt: {
    ...
    dashboard: "Painel", planList: "Planos", newPlan: "Novo plano",
  ...
  it: {
    ...
    dashboard: "Dashboard", planList: "Piani", newPlan: "Nuovo piano",
  ...
  ar: {
    ...
    dashboard: "لوحة التحكم", planList: "الخطط", newPlan: "خطة جديدة",
