...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    dashboard: "工作台", planList: "行程列表", routes: "经典线路", qa: "智能问答", newPlan: "新建行程", voicePlan: "语音创建", chatPlan: "对话式创建",
  ...
  en: {
    ...
    dashboard: "Dashboard", planList: "Plans", routes: "Classic Routes", qa: "AI Q&A", newPlan: "New Plan", voicePlan: "Voice Plan", chatPlan: "Chat Plan",
  ...
  ja: {
    ...
    dashboard: "ダッシュボード", planList: "プラン一覧", routes: "定番ルート", qa: "AI質問", newPlan: "新規プラン", voicePlan: "音声作成", chatPlan: "チャット作成",
  ...
  ko: {
    ...
    dashboard: "대시보드", planList: "여행 목록", routes: "클래식 루트", qa: "AI 질문", newPlan: "새 여행", voicePlan: "음성 생성", chatPlan: "채팅 생성",
  ...
  fr: {
    ...
    dashboard: "Tableau de bord", planList: "Plans", routes: "Itinéraires", qa: "Q&R IA", newPlan: "Nouveau plan", voicePlan: "Création vocale", chatPlan: "Création par chat",
  ...
  de: {
    ...
    dashboard: "Dashboard", planList: "Pläne", routes: "Klassische Routen", qa: "KI-Fragen", newPlan: "Neuer Plan", voicePlan: "Spracherstellung", chatPlan: "Chat-Erstellung",
  ...
  es: {
    ...
    dashboard: "Panel", planList: "Planes", routes: "Rutas clásicas", qa: "Preguntas IA", newPlan: "Nuevo plan", voicePlan: "Creación por voz", chatPlan: "Creación por chat",
  ...
  ru: {
    ...
    dashboard: "Панель", planList: "Планы", routes: "Классические маршруты", qa: "ИИ-вопросы", newPlan: "Новый план", voicePlan: "Голосовое создание", chatPlan: "Создание в чате",
  ...
  pt: {
    ...
    dashboard: "Painel", planList: "Planos", routes: "Rotas clássicas", qa: "Perguntas IA", newPlan: "Novo plano", voicePlan: "Criação por voz", chatPlan: "Criação por chat",
  ...
  it: {
    ...
    dashboard: "Dashboard", planList: "Piani", routes: "Itinerari classici", qa: "Domande IA", newPlan: "Nuovo piano", voicePlan: "Creazione vocale", chatPlan: "Creazione chat",
  ...
  ar: {
    ...
    dashboard: "لوحة التحكم", planList: "الخطط", routes: "مسارات كلاسيكية", qa: "أسئلة ذكية", newPlan: "خطة جديدة", voicePlan: "إنشاء صوتي", chatPlan: "إنشاء بالمحادثة",
