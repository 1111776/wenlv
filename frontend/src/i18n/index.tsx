...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    dashboard: "工作台", planList: "行程列表", newPlan: "新建行程", qaPlan: "问答式创建", voicePlan: "语音创建", chatPlan: "对话式创建",
  ...
  en: {
    ...
    dashboard: "Dashboard", planList: "Plans", newPlan: "New Plan", qaPlan: "Guided Plan", voicePlan: "Voice Plan", chatPlan: "Chat Plan",
  ...
  ja: {
    ...
    dashboard: "ダッシュボード", planList: "プラン一覧", newPlan: "新規プラン", qaPlan: "対話式作成", voicePlan: "音声作成", chatPlan: "チャット作成",
  ...
  ko: {
    ...
    dashboard: "대시보드", planList: "여행 목록", newPlan: "새 여행", qaPlan: "대화형 생성", voicePlan: "음성 생성", chatPlan: "채팅 생성",
  ...
  fr: {
    ...
    dashboard: "Tableau de bord", planList: "Plans", newPlan: "Nouveau plan", qaPlan: "Création guidée", voicePlan: "Création vocale", chatPlan: "Création par chat",
  ...
  de: {
    ...
    dashboard: "Dashboard", planList: "Pläne", newPlan: "Neuer Plan", qaPlan: "Geführte Erstellung", voicePlan: "Spracherstellung", chatPlan: "Chat-Erstellung",
  ...
  es: {
    ...
    dashboard: "Panel", planList: "Planes", newPlan: "Nuevo plan", qaPlan: "Creación guiada", voicePlan: "Creación por voz", chatPlan: "Creación por chat",
  ...
  ru: {
    ...
    dashboard: "Панель", planList: "Планы", newPlan: "Новый план", qaPlan: "Пошаговое создание", voicePlan: "Голосовое создание", chatPlan: "Создание в чате",
  ...
  pt: {
    ...
    dashboard: "Painel", planList: "Planos", newPlan: "Novo plano", qaPlan: "Criação guiada", voicePlan: "Criação por voz", chatPlan: "Criação por chat",
  ...
  it: {
    ...
    dashboard: "Dashboard", planList: "Piani", newPlan: "Nuovo piano", qaPlan: "Creazione guidata", voicePlan: "Creazione vocale", chatPlan: "Creazione chat",
  ...
  ar: {
    ...
    dashboard: "لوحة التحكم", planList: "الخطط", newPlan: "خطة جديدة", qaPlan: "إنشاء موجه", voicePlan: "إنشاء صوتي", chatPlan: "إنشاء بالمحادثة",
