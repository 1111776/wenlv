...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    dashboard: "工作台", planList: "行程列表", newPlan: "新建行程", qaPlan: "问答式创建",
  ...
  en: {
    ...
    dashboard: "Dashboard", planList: "Plans", newPlan: "New Plan", qaPlan: "Guided Plan",
  ...
  ja: {
    ...
    dashboard: "ダッシュボード", planList: "プラン一覧", newPlan: "新規プラン", qaPlan: "対話式作成",
  ...
  ko: {
    ...
    dashboard: "대시보드", planList: "여행 목록", newPlan: "새 여행", qaPlan: "대화형 생성",
  ...
  fr: {
    ...
    dashboard: "Tableau de bord", planList: "Plans", newPlan: "Nouveau plan", qaPlan: "Création guidée",
  ...
  de: {
    ...
    dashboard: "Dashboard", planList: "Pläne", newPlan: "Neuer Plan", qaPlan: "Geführte Erstellung",
  ...
  es: {
    ...
    dashboard: "Panel", planList: "Planes", newPlan: "Nuevo plan", qaPlan: "Creación guiada",
  ...
  ru: {
    ...
    dashboard: "Панель", planList: "Планы", newPlan: "Новый план", qaPlan: "Пошаговое создание",
  ...
  pt: {
    ...
    dashboard: "Painel", planList: "Planos", newPlan: "Novo plano", qaPlan: "Criação guiada",
  ...
  it: {
    ...
    dashboard: "Dashboard", planList: "Piani", newPlan: "Nuovo piano", qaPlan: "Creazione guidata",
  ...
  ar: {
    ...
    dashboard: "لوحة التحكم", planList: "الخطط", newPlan: "خطة جديدة", qaPlan: "إنشاء موجه",
