...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    dashboard: "工作台", planList: "行程列表", newPlan: "新建行程", voicePlan: "语音创建", chatPlan: "对话式创建",
  ...
  en: {
    ...
    dashboard: "Dashboard", planList: "Plans", newPlan: "New Plan", voicePlan: "Voice Plan", chatPlan: "Chat Plan",
  ...
  ja: {
    ...
    dashboard: "ダッシュボード", planList: "プラン一覧", newPlan: "新規プラン", voicePlan: "音声作成", chatPlan: "チャット作成",
  ...
  ko: {
    ...
    dashboard: "대시보드", planList: "여행 목록", newPlan: "새 여행", voicePlan: "음성 생성", chatPlan: "채팅 생성",
  ...
  fr: {
    ...
    dashboard: "Tableau de bord", planList: "Plans", newPlan: "Nouveau plan", voicePlan: "Création vocale", chatPlan: "Création par chat",
  ...
  de: {
    ...
    dashboard: "Dashboard", planList: "Pläne", newPlan: "Neuer Plan", voicePlan: "Spracherstellung", chatPlan: "Chat-Erstellung",
  ...
  es: {
    ...
    dashboard: "Panel", planList: "Planes", newPlan: "Nuevo plan", voicePlan: "Creación por voz", chatPlan: "Creación por chat",
  ...
  ru: {
    ...
    dashboard: "Панель", planList: "Планы", newPlan: "Новый план", voicePlan: "Голосовое создание", chatPlan: "Создание в чате",
  ...
  pt: {
    ...
    dashboard: "Painel", planList: "Planos", newPlan: "Novo plano", voicePlan: "Criação por voz", chatPlan: "Criação por chat",
  ...
  it: {
    ...
    dashboard: "Dashboard", planList: "Piani", newPlan: "Nuovo piano", voicePlan: "Creazione vocale", chatPlan: "Creazione chat",
  ...
  ar: {
    ...
    dashboard: "لوحة التحكم", planList: "الخطط", newPlan: "خطة جديدة", voicePlan: "إنشاء صوتي", chatPlan: "إنشاء بالمحادثة",
