...
| 知识库规模 | 10 篇语料 / 61 chunk（景点15+美食14+政策6+四季10+交通5+住宿5+注意事项6） |
| 质量评估 | Hit@1 65% / Hit@3 95% / Hit@5 95% / MRR 0.792（20 条测试集） |
| 诚实说明 | rerank 接口被当前 MaaS 网关 404，走降级关键词打分；代码已实现真 rerank，网关开放后自动启用 |
